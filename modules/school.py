...
class School(object):
    ...
    def add_schoolteacher(self,teacher_name,teacher_gender,teacher_age,teacher_salary,teacher_phonenumber):
        '''添加学校讲师对象到self.school_teacher字典中'''
        newteacher = Teacher(teacher_name,teacher_gender,teacher_age,teacher_salary,teacher_phonenumber)
